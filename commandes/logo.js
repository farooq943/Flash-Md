...
zokou({ nomCom: "hacker",
    ...
    if (!arg || arg == "") {
        repondre("*__Exemple : * " + prefixe + "𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜");
        return;
    }
    try {
...
zokou({ nomCom: "dragonball", categorie: "Logo", reaction: "🐉" }, async (dest, zk, commandeOptions) => {
    ...
    try {
        const noArgMsg = `*_EXEMPLE *:  ${prefixe}dragonball 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜`;
       ...
       // var idImg = Object.values(imgInfo)[3];
        ...
        await zk.sendMessage(dest, { image: { url: imgInfo.image }, caption: " \t *Logo by 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜*" }, { quoted: ms });
    }
    catch (e) {
        repondre("🥵🥵 " + e);
    }
...
zokou({ nomCom: "naruto", categorie: "Logo", reaction: "⛩" }, async (dest, zk, commandeOptions) => {
    ...
    try {
        if (!arg || arg == '') {
            repondre("*_Exemple : * " + prefixe + "naruto 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜");
            return;
        }
        ...
        await zk.sendMessage(dest, { image: { url: img.image }, caption: "\t *Logo by 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜*" }, { quoted: ms });
    }
    catch (e) {
        repondre("🥵🥵 " + e);
    }
...
/*zokou({ nomCom: "didong", categorie: "Logo", reaction: "📱" }, async (dest, zk, commandeOptions) => {
    ...
    var titre = "\t logo by 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜";
    try {
...
zokou({ nomCom: "didong", categorie: "Logo", reaction: "📱" }, async (dest, zk, commandeOptions) => {
   ...
   try {
     var titre = "\t *Logo by 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜*";
      var lien = "https://ephoto360.com/tao-anh-che-vui-tu-choi-cuoc-goi-voi-ten-cua-ban-930.html";
        if (!arg || arg == "") {
           repondre(`*exemple :* ${prefixe}didong 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜`)
            return ;
        }
...
zokou({nomCom: "summer", categorie: "Logo", reaction: "🌞"}, async (dest, zk, commandeOptions) => {
  ...
  mumaker.textpro("https://textpro.me/create-sunset-light-text-effects-online-for-free-1124.html", text)
    .then((data) => {
      zk.sendMessage(dest, { image: { url: data.image }, caption: 'Logo by *𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜*' }, { quoted: ms });
    })
    .catch(console.error);
});
...
zokou({nomCom: "neonlight", categorie: "Logo", reaction: "💡"}, async (dest, zk, commandeOptions) => {
  ...
  try{
    ...
    /*.then((data) => {*/
     zk.sendMessage(dest, { image: { url: maker.image }, caption: 'Logo by *𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜*' }, { quoted: ms });
  ...
  {nomCom:"boom",categorie:
    ...
    let {ms,repondre,prefixe,arg}=commandeOptions;
        ...
        if(!arg||arg=="")
        {
          ...
          repondre(`  Exemple :* ${prefixe}boom 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜`)
          return ;
        }
       try{
              var radio2 = "e0723d60-fc0d-421f-bf8f-a9b9b61e4be6";
...
repondre("  processing ...")
         await zk.sendMessage(dest,{image:{url:img.image},caption:"\t *Logo by 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜*"})
         
        // await zk.sendMessage(dest,{image:{url:lienImage},caption:"\t *Logo by 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜*"})
...
zokou({nomCom:"gold",categorie:"Logo",reaction:"🧚🏿‍♀️"},async(dest,zk,commandeOptions)=>{
  ...
  try{
      if(!arg||arg=="")
      {
        repondre(prefixe+"gold 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜");return;
      }
...
zokou({nomCom:"arena",categorie:"Logo",reaction:"🥵"},async(dest,zk,commandeOptions)=>{
  ...
  try{
      if(!arg||arg=="")
      {
        repondre(prefixe+"arena 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜");return;
      }
...
zokou({nomCom:"incandescent",categorie:"Logo",reaction:"😋"},async(dest,zk,commandeOptions)=>{
  ...
  try{
      if(!arg||arg=="")
      {
        repondre(prefixe+"incandescent 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜");return;
      }
...
zokou({nomCom:"child",categorie:"Logo",reaction:"😇"},async(dest,zk,commandeOptions)=>{
  ...
  try{
      if(!arg||arg=="")
      {
        repondre(prefixe+"child 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜");return;
      }
...
zokou({nomCom:"typo",categorie:"Logo",reaction:"😇"},async(dest,zk,commandeOptions)=>{
  ...
  try{
      if(!arg||arg=="")
      {
        repondre(prefixe+"typo 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜");return;
      }
...
zokou({nomCom:"light",categorie:"Logo",reaction:"🌠"},async(dest,zk,commandeOptions)=>{
  ...
  try{
      if(!arg||arg=="")
      {
        repondre(prefixe+"light 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜");return;
      }
...
zokou({nomCom:"steel",categorie:"Logo",reaction:"🌠"},async(dest,zk,commandeOptions)=>{
  ...
  try{
      if(!arg||arg=="")
      {
        repondre(prefixe+"steel 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜");return;
      }
...
zokou({nomCom:"sunlight",categorie:"Logo",reaction:"🌠"},async(dest,zk,commandeOptions)=>{
  ...
  try{
      if(!arg||arg=="")
      {
        repondre(prefixe+"sunlight 𝗙𝗔𝗥𝗢𝗢𝗤-𝗠𝗔𝗚𝗦𝗜");return;
      }
